 ...
 * between th3d, and th3-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mathyias/TH3Coin>";
    const std::string URL_WEBSITE = "<https://th3chain.cloud>";
